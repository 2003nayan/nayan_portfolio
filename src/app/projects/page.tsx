      ...
      <section id="projects">
        <BlurFade delay={BLUR_FADE_DELAY * 11}>
          <Tabs defaultValue="myworks" className="flex flex-col items-center justify-center w-full">
            <TabsList className="grid w-[400px] grid-cols-2 mb-4 gap-3">
              <TabsTrigger value="myworks" className="border-black/15 border">Self Grinds</TabsTrigger>
              <TabsTrigger value="clientworks" className="border-black/15 border">Client Hustle</TabsTrigger>
            </TabsList>
                ...
                <div className="space-y-12 w-full">
                  <div className="flex flex-col items-center justify-center space-y-4 text-center">
                    <div className="space-y-2">
                      ...
                      <p className="text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                        I&apos;ve had the pleasure of working with some amazing clients on a variety of projects. Here&apos;s a showcase of my client work.
                      </p>
                    </div>
                  </div>
                  <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 max-w-[800px] mx-auto">
